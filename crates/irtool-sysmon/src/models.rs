...
pub fn is_suspicious_remote_thread(source_name: &str, target_name: &str) -> bool {
    const SUSPICIOUS_SOURCES: &[&str] = &[
        "rundll32.exe", "regsvr32.exe", "mshta.exe", "powershell.exe", "cmd.exe",
    ];
...
pub fn default_event_configs() -> Vec<EventConfigEntry> {
    vec![
        ...
        EventConfigEntry { key: "driver_load".into(), name: "驱动加载".into(), event_id: 6, xml_tag: "DriverLoad".into(), default_enabled: false },
        EventConfigEntry { key: "image_load".into(), name: "DLL加载".into(), event_id: 7, xml_tag: "ImageLoad".into(), default_enabled: false },
        EventConfigEntry { key: "remote_thread".into(), name: "远程线程创建".into(), event_id: 8, xml_tag: "CreateRemoteThread".into(), default_enabled: false },
        EventConfigEntry { key: "raw_access_read".into(), name: "原始磁盘访问".into(), event_id: 9, xml_tag: "RawAccessRead".into(), default_enabled: false },
        EventConfigEntry { key: "process_access".into(), name: "进程访问".into(), event_id: 10, xml_tag: "ProcessAccess".into(), default_enabled: false },
        EventConfigEntry { key: "file_create".into(), name: "文件创建".into(), event_id: 11, xml_tag: "FileCreate".into(), default_enabled: false },
        EventConfigEntry { key: "registry_event".into(), name: "注册表事件".into(), event_id: 12, xml_tag: "RegistryEvent".into(), default_enabled: false },
        EventConfigEntry { key: "file_create_stream_hash".into(), name: "文件流哈希".into(), event_id: 15, xml_tag: "FileCreateStreamHash".into(), default_enabled: false },
        EventConfigEntry { key: "pipe_event".into(), name: "管道事件".into(), event_id: 17, xml_tag: "PipeEvent".into(), default_enabled: false },
        EventConfigEntry { key: "wmi_event".into(), name: "WMI事件".into(), event_id: 19, xml_tag: "WmiEvent".into(), default_enabled: false },
        EventConfigEntry { key: "file_delete".into(), name: "文件删除".into(), event_id: 23, xml_tag: "FileDelete".into(), default_enabled: false },
        EventConfigEntry { key: "clipboard_change".into(), name: "剪贴板变化".into(), event_id: 24, xml_tag: "ClipboardChange".into(), default_enabled: false },
        EventConfigEntry { key: "process_tampering".into(), name: "进程篡改".into(), event_id: 25, xml_tag: "ProcessTampering".into(), default_enabled: false },
        EventConfigEntry { key: "file_delete_detected".into(), name: "文件删除检测".into(), event_id: 26, xml_tag: "FileDeleteDetected".into(), default_enabled: false },
    ]
}
