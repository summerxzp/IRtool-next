...
# 1. Rust format check
Write-Host "`n[1/4] cargo fmt --check..." -ForegroundColor Yellow
cargo fmt --all -- --check
...
# 2. Clippy
Write-Host "`n[2/4] cargo clippy..." -ForegroundColor Yellow
...
# 3. Tests
Write-Host "`n[3/4] cargo test..." -ForegroundColor Yellow
...
# 4. UI type check
Write-Host "`n[4/4] UI type check..." -ForegroundColor Yellow
